...
```{r}
  ggplot(data=Products[[k]], aes(x=c(2000:2020))) +
      geom_line(aes(y =totalsPerCapita[[k]]))+
      geom_line(color='#E51837', aes(y=importsPerCapita[[k]]))+
      geom_line(color='#0004FF',aes(y=domesticPerCapita[[k]]))+
